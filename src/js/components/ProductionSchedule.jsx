    ...
    <Tables
      ...
      columns={[
        ...
        },
        {
          ...
          flex: 1,
          minWidth: 150,
          cellClassName: (params) => params.value.trim() && 'highlight-1',
        },
        {
          field: "SIDE3",
          headerName: "Side 3",
        ...
        },
        {
          ...
          flex: 1,
          minWidth: 150,
          cellClassName: (params) => params.value.trim() && 'highlight-2',
        },
        {
          field: "SIDE2",
          headerName: "Side 2",
        ...
        },
        {
          ...
          flex: 1,
          minWidth: 150,
          cellClassName: (params) => params.value.trim() && 'highlight-3',
        },
        {
          field: "SIDE1",
          headerName: "Side 1",
